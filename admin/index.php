...
<body id="page-top">
    ...
    <?php
        require '../conn.php';
        $table = "rescuer";
        $sql = "SELECT COUNT(*) AS totalRescuers FROM $table";
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="profile.php"><i class="fas fa-user"></i><span>Rescuers</span></a><a class="nav-link" href="predict.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cloud-lightning-rain-fill">
                        ...
                        <div class="bg-dark border rounded border-0 border-dark overflow-hidden">
                            <div class="row g-0">
                                ...
                                <div class="col-md-6 order-first order-md-last">
                                    <iframe src="interactive_flood_map (1).html" style="max-width: 800px;max-height: 600px; height: 100%!important;width: 100%!important;"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card shadow border-start-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>number of Rescuers</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span> <?php echo $totalRescuers; ?> </span></div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span> <?php echo $rescuedPeople; ?> </span></div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span> <?php echo $deaths; ?> </span></div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span> <?php echo $numberOfAffectedCommunities; ?> </span></div>
                                        </div>
