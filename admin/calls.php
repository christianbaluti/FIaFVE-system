            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="profile.php"><i class="fas fa-user"></i><span>Rescuers</span></a><a class="nav-link" href="predict.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cloud-lightning-rain-fill">
                            ...
                            </svg><span style="margin-left: 6px;">Message Broadcast</span></a><a class="nav-link active" href="calls.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-phone-landscape-fill">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 fw-bold">Victims voicemail</p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                <div class="col-md-6">
                            ...
                            <table class="table my-0" id="dataTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Dyelatu</td>
                                        <td>2012/10/13<br></td>
                                        <td><button class="btn btn-primary btn-sm" type="submit">Play</button></td>
                                    </tr>
                                    <tr></tr>
                                </tbody>
                                <tfoot>
