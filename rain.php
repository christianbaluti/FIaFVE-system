            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="profile.php"><i class="fas fa-user"></i><span>Rescuer Registration</span></a><a class="nav-link" href="predict.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cloud-lightning-rain-fill">
                            ...
                            </svg><span style="margin-left: 6px;">Floods Predictions</span></a><a class="nav-link active" href="rain.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-cloud-hail">
                            ...
                            </svg><span style="margin-left: 6px;">Rain Predictions</span></a><a class="nav-link" href="rescuers.php"><i class="fa fa-file-archive-o"></i><span style="margin-left: 6px;">Rescuers</span></a></li>
                    ...
                    <div class="container">
                        <div class="bg-dark border rounded border-0 border-dark overflow-hidden">
                            <div class="row g-0">
                                ...
                                <div class="col-md-6 order-first order-md-last" style="min-height: 250px;"><img class="w-100 h-100 fit-cover" src="assets/img/nasa-i9w4Uy1pU-s-unsplash.jpg" style="max-height: 458px;"></div>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="col-lg-7 col-xl-8">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Historical Rain Overview</h6><select class="form-select" id="subject" style="margin-left: -1px;width: 188.297px;padding-left: 15px;padding-right: 10px;">
                                        <optgroup label="Year">
